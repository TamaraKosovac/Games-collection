...
<div>
  <img src="Screenshots/register.png" alt="Register screen" width="250" style="margin-left: 20px; margin-right: 10px;" />
...
<div>
  <img src="Screenshots/firstGame.png" alt="Tic-Tac-Toe game" width="250" style="margin-left: 20px; margin-right: 10px;" />
...
<div>
  <img src="Screenshots/secondGame.png" alt="Memory Match game" width="250" style="margin-left: 20px; margin-right: 10px;" />
...
<div>
  <img src="Screenshots/thirdGame.png" alt="Sudoku game" width="250" style="margin-left: 20px; margin-right: 10px;" />
...
<div>
  <img src="Screenshots/results.png" alt="Results screen" width="250" style="margin-left: 20px; margin-right: 10px;" />
